...
public class SoundEffectManager : SingletonAbstract<SoundEffectManager>
{
    ...
    private void Start()
    {
        // Check if player has set the sound effect volume in the previous play
    ...
    public void PlaySoundEffect(SoundEffectSO soundEffect)
    {
        ...
        sound.SetSound(soundEffect); // Set base values for the sound effect from SoundEffectSO
