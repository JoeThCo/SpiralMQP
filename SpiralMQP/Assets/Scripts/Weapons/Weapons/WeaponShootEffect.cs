...
public class WeaponShootEffect : MonoBehaviour
{
    ...
    public void SetShootEffect(WeaponShootEffectSO shootEffect, float aimAngle)
    {
        ...
        // Set shoot effect particle rendering sprite
    ...
    {
        // Set colour gradient
        ParticleSystem.ColorOverLifetimeModule colorOverLifetimeModule = shootEffectParticleSystem.colorOverLifetime; // This step could be redundent, but all the tutorials use this pattern.
    ...
    private void SetShootEffectParticleSprite(Sprite sprite)
    {
        ...
        textureSheetAnimationModule.SetSprite(0, sprite); // Only need one sprite in our current game for each particle effect
