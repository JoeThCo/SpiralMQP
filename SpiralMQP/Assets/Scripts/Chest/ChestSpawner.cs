...
public class ChestSpawner : MonoBehaviour
{
    ...
    private struct RangeByLevel
    {
        ...
        // Max and Min spawn percent for the spawning item
    ...
    private void SpawnChest()
    {
        ...
        else if (chestSpawnPosition == ChestSpawnPosition.atPlayerPosition)
        {
            ...
            chestGameObject.transform.position = spawnPosition + variation; // Variation is added for better visual look 
        }
    ...
    private void GetItemsToSpawn(out int ammo, out int health, out int weapons)
    {
        ...
        {
            choice = Random.Range(0, 3);
            if (weaponSpawnByLevelList.Count == 0) {ammo++; health++; return;} // For now, dreamy don't need any other weapon
