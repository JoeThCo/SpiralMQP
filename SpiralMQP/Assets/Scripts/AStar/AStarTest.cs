...
/// <summary>
/// To display a test path in any of the dungeon room for AStar testing 
/// **IMPORTANT: THIS IS JUST A TEST SCRIPT** 
/// </summary>
public class AStarTest : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Set start position using I key
        ...
        // Once the start and end positions are being set, display the path using P key
