...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    [SerializeField] private Transform ammoHolderTransform; // The parent container for all the ammo icon
    ...
    private List<GameObject> ammoIconList = new List<GameObject>(); // The list of all ammo icons shown in the UI
    ...
    {
        UpdateAmmoText(weapon); // How many bullets we have
        UpdateAmmoLoadedIcons(weapon); // How many bullets we have in our clip
        UpdateReloadText(weapon); // Flash to inform player to reload
    }
    ...
    private IEnumerator UpdateWeaponReloadBarRoutine(Weapon currentWeapon)
    {
        ...
        {
            // Update reloadbar
            float barFill = currentWeapon.weaponReloadTimer / currentWeapon.weaponDetails.weaponReloadTime; // Calculate the percentage progress of the reload bar
